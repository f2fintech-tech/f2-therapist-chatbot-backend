...
with zipfile.ZipFile(excel_path, "r") as z:
    ...
    print("Searching for cells with values related to 4 lakh or 400000:")
        ...
        for c in row.findall('.//ns:c', ns):
            ...
            if v_elem is not None and v_elem.text:
                ...
                if t_type == 's':
                    ...
                    val = val_str
            if val is not None and ("400" in str(val) or "4,00" in str(val) or "4 lakh" in str(val).lower() or "40,00" in str(val) or "400000" in str(val)):
