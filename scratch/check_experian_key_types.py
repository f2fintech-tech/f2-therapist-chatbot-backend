...
payloads = [
    # 1. client_ref_num as UUID hex (no hyphens)
    {
        "client_ref_num": uuid.uuid4().hex,
        "name": "Ranjit Kumar Singh",
        "phone": "8271987892"
    },
    # 2. client_ref_num as numeric string
    {
        "client_ref_num": "12345678901234567890",
        "name": "Ranjit Kumar Singh",
        "phone": "8271987892"
    },
    # 3. phone as integer
    ...
    # 4. phone as integer, mobile key name
    {
        "client_ref_num": uuid.uuid4().hex,
        "name": "Ranjit Kumar Singh",
        "mobile": 8271987892
    },
    # 5. Using all lowercase name
    {
        "client_ref_num": uuid.uuid4().hex,
        "name": "ranjit kumar singh",
        "phone": "8271987892"
